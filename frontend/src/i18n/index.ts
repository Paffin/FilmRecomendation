...
const messages = {
  ru: {
    ...
    recommendations: {
      ...
      contextHint:
        'Ползунки и селекторы выше — это живой «режим вечера»: меняйте их и наблюдайте, как подборка перестраивается под настроение, компанию и доступное время.',
    },
    watchlist: {
